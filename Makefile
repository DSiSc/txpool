...
help:
	@echo 'Management commands for DSiSc/txpool:'
	@echo
	@echo 'Usage:'
...
build:
	@echo "building txpool ${VERSION}"
	@echo "GOPATH=${GOPATH}"
	go build -v -ldflags "-X github.com/DSiSc/txpool/version.GitCommit=${GIT_COMMIT}${GIT_DIRTY} -X github.com/DSiSc/txpool/version.BuildDate=${BUILD_DATE}" ./...
